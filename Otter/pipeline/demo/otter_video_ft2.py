...
def train_one_epoch(args,generate_model, model, epoch, mimicit_loader, tokenizer, optimizer, lr_scheduler, device_id, accelerator, wandb):
    ...
    for num_steps, batch in tqdm(
        ...
        if accelerator.is_local_main_process and global_step != 0 and (args.save_steps_interval != -1) and global_step%args.save_steps_interval==0:
...
def parse_args():
    ...
    parser.add_argument("--logging_steps", type=int, default=20, help="log loss every n steps")
    # Sum of gradient optimization batch size
    parser.add_argument("--batch_size", type=int, default=16)
    parser.add_argument("--train_num_samples", type=int, default=-1)
    parser.add_argument("--gradient_accumulation_steps", type=int, default=1)
    parser.add_argument("--save_steps_interval", type=int, default=100)
    parser.add_argument(
